...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2025b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODULES              := ClosedLoopSystem_PID_Exp_python_block_2_data.c ClosedLoopSystem_PID_Exp_python_block_2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ClosedLoopSystem_PID_Exp_python_block_2.mk
...
TID01EQ              := 0
NCSTATES             := 0
BUILDARGS            :=  REAL_TIME_EXECUTION="kernel" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2025b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ClosedLoopSystem_PID_Exp_python_block_2_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Code/reinforcement_learning/Reinforcement-Learning-Inverted-Pendulum-with-QUBE-Servo3/MATLAB/Qube-Servo-2/Cache$(WQ);$(WQ)C:/Code/reinforcement_learning/Reinforcement-Learning-Inverted-Pendulum-with-QUBE-Servo3/MATLAB/Qube-Servo-2/Cache/ClosedLoopSystem_PID_Exp_python_block_2_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
